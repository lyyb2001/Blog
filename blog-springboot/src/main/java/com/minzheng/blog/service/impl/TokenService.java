...
import com.minzheng.blog.constant.Constants;
...
//            // 解析对应的权限以及用户信息
//            String uuid =  claims.get(Constants.LOGIN_USER_KEY).asString();
...
//        loginUser.setOs(userAgent.getPlatform().getName());
//    }
//
//    /**
//     * 从数据声明生成令牌
...
//    {
//        String token = JWT.create().withClaim(Constants.LOGIN_USER_KEY,uuid).sign(Algorithm.HMAC512(secret));
//        return token;
//    }
//
//    /**
